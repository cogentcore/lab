...
fn JointPTorque(idx: i32) -> vec3<f32> {
	return vec3<f32>(Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointPTorqueX))], Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointPTorqueY))], Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointPTorqueZ))]);
}
fn JointCForce(idx: i32) -> vec3<f32> {
	return vec3<f32>(Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointCForceX))], Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointCForceY))], Joints[Index2D(TensorStrides[10], TensorStrides[11], u32(idx), u32(JointCForceZ))]);
}
