...
fn DynamicsCurToNext(i: u32) { //gosl:kernel
	...
	for (var di = DynIndex; di < DynamicVarsN; di++) {
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(params.Next), u32(di))] = Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(params.Cur), u32(di))];
	}
}
