...
fn InitDynamics(i: u32) { //gosl:kernel
	...
	for (var cni=0; cni<2; cni++) {
		var bi = DynamicIndex(ii, i32(cni));
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynPosX))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyPosX))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynPosY))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyPosY))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynPosZ))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyPosZ))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynQuatX))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyQuatX))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynQuatY))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyQuatY))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynQuatZ))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyQuatZ))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynQuatW))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyQuatW))];
		for (var v = DynVelX; v < DynamicVarsN; v++) {
			Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42],
