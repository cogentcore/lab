...
fn InitDynamics(i: u32) { //gosl:kernel
	...
	for (var cni=0; cni<2; cni++) {
		...
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynRotX))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyRotX))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynRotY))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyRotY))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynRotZ))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyRotZ))];
		Dynamics[Index3D(TensorStrides[40], TensorStrides[41], TensorStrides[42], u32(ii), u32(cni), u32(DynRotW))] = Bodies[Index2D(TensorStrides[0], TensorStrides[1], u32(bi), u32(BodyRotW))];
