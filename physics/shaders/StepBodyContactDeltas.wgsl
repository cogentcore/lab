...
fn ContactADelta(idx: i32) -> vec3<f32> {
	return vec3<f32>(Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactADeltaX))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactADeltaY))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactADeltaZ))]);
}
fn ContactAAngDelta(idx: i32) -> vec3<f32> {
	return vec3<f32>(Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactAAngDeltaX))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactAAngDeltaY))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactAAngDeltaZ))]);
}
fn ContactBDelta(idx: i32) -> vec3<f32> {
	return vec3<f32>(Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBDeltaX))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBDeltaY))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBDeltaZ))]);
}
fn ContactBAngDelta(idx: i32) -> vec3<f32> {
	return vec3<f32>(Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBAngDeltaX))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBAngDeltaY))], Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(idx), u32(ContactBAngDeltaZ))]);
}
fn StepBodyContactDeltas(i: u32) { //gosl:kernel
	...
	for (var ci=0; ci<cmax; ci++) {
		var wt = Contacts[Index2D(TensorStrides[100], TensorStrides[101], u32(ci), u32(ContactWeight))];
	...
	Dynamics[Index3D(TensorStrides[60], TensorStrides[61], TensorStrides[62], u32(di), u32(params.Next), u32(DynContactWeight))] = tw;
