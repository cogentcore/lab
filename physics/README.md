...
The [world](world) visualization sub-package generates an [xyz](https://cogentcore.org/xyz) 3D scenegraph based on the physics bodies, and updates this visualization efficiently as the physics is updated.
