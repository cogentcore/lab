...
var Replaces = []Replace{
	...
	{[]byte("slvec.Vector3i"), []byte("vec4<i32>")},
	{[]byte("slvec.Vector2"), []byte("vec4<f32>")},
	{[]byte("slvec.Vector3"), []byte("vec4<f32>")},
	{[]byte("math32.X"), []byte("0")},
	{[]byte("math32.Y"), []byte("1")},
	{[]byte("math32.Z"), []byte("2")},
	{[]byte("math32.W"), []byte("3")},
	{[]byte("math32.Vector2i"), []byte("vec2<i32>")},
	{[]byte("math32.Vector3i"), []byte("vec3<i32>")},
	...
	{[]byte("math32.Vec3i"), []byte("vec3<i32>")},
