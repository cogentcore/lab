...
// SetOutOfRange sets the [PlotStyle.OutOfRange]:
// OutOfRange specifies how to handle out-of-range values, when a
// range has been set with fixed Min or Max values that exclude some
// data points.
func (t *PlotStyle) SetOutOfRange(v OutOfRange) *PlotStyle { t.OutOfRange = v; return t }
...
// SetOutOfRangeMark sets the [Style.OutOfRangeMark]:
// OutOfRangeMark has style properties for drawing points when out of range.
func (t *Style) SetOutOfRangeMark(v PointStyle) *Style { t.OutOfRangeMark = v; return t }
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/lab/plot.OutOfRange", IDName: "out-of-range", Doc: "OutOfRange specifies how to plot out-of-range values."})
