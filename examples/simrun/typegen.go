...
var _ = types.AddType(&types.Type{Name: "main.SimRun", IDName: "sim-run", Doc: "SimRun is a data browser with the files as the left panel,\nand the Tabber as the right panel.", Methods: []types.Method{{Name: "Jobs", Doc: "Jobs updates the Jobs tab with a Table showing all the Jobs\nwith their meta data.  Uses the dbmeta.toml data compiled from\nthe Status function.", Directives: []types.Directive{{Tool: "types", Directive: "add"}}}}, Embeds: []types.Field{{Name: "Frame"}, {Name: "Browser"}}, Fields: []types.Field{{Name: "Config", Doc: "Config holds all the configuration settings."}, {Name: "JobsTableView", Doc: "JobsTableView is the view of the jobs table."}, {Name: "JobsTable", Doc: "JobsTable is the jobs Table with one row per job."}, {Name: "ResultsTableView", Doc: "ResultsTableView has the results table."}, {Name: "Results", Doc: "Results is the list of result records."}}})
...
// SetResults sets the [SimRun.Results]:
// Results is the list of result records.
func (t *SimRun) SetResults(v ...*Result) *SimRun { t.Results = v; return t }
